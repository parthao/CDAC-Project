    ...
    <div>
      <div className='row'>
        <div className='col-md-3 fixed-top back' style={{ height: "100%" }}>
          ...
          <hr></hr>
          <div className='row'>
          <Link className="linkx" to="/updatepass"><div className='col-md-12 smtext'>
              <img className="smlogo" src={updatepass}></img> &nbsp;&nbsp;&nbsp; Update Password
            </div></Link>
          </div>
          <hr></hr>
        <div className='row'>
        ...
        <div class="col-sm-9 offset-sm-3 col-xs-9 offset-xs-3 two">
         <Switch>
          ...
          <Route exact path="/updatepass" component={ArtistPass}/>
         </Switch>
        </div>
      </div>
    </div>
